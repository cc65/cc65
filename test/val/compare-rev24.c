...
**   unsigned char: autos, static arrays.
...
#define TEST_NAME  "compare-rev24"
...
/* unsigned char to static arrays compares */
/* General form: if (loc >= array[x_val]) */
static void uchar_loc_to_statarr_11(void)
{
    unsigned char v;
...
static void uchar_loc_to_statarr_13(void)
{
    unsigned char v;
...
static void uchar_loc_to_statarr_15(void)
{
    unsigned char v;
...
static void uchar_loc_to_statarr_17(void)
{
    unsigned char v;
...
static void uchar_loc_to_statarr_19(void)
{
    unsigned char v;
...
int main(void)
{
    ...
    uchar_loc_to_statarr_15();
    uchar_loc_to_statarr_17();
    uchar_loc_to_statarr_19();

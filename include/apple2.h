...
extern char CH_HLINE_SCRCODE;
extern char CH_VLINE_SCRCODE;
...
#define _chline(length)         dyn_chline(CH_HLINE_SCRCODE, length)
#define _chlinexy(x, y, length) dyn_chlinexy(CH_HLINE_SCRCODE,x ,y, length)
#define _cvline(length)         dyn_cvline(CH_VLINE_SCRCODE, length)
#define _cvlinexy(x, y, length) dyn_cvlinexy(CH_VLINE_SCRCODE, x, y, length)
...
#define CH_RTEE         '+'
#define CH_CROSS        '+'
#define _chline(length)         dyn_chline(CH_HLINE|0x80, length)
#define _chlinexy(x, y, length) dyn_chlinexy(CH_HLINE|0x80, x, y, length)
#define _cvline(length)         dyn_cvline(CH_VLINE|0x80, length)
#define _cvlinexy(x, y, length) dyn_cvlinexy(CH_VLINE|0x80, x, y, length)
#endif /* DYN_BOX_DRAW */
#endif /* __APPLE2ENH__ */

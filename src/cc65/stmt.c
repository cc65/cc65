...
static int IsTypeToken(void)
{
    ...
    case TOK_IDENT: {
        ...
        SymEntry *Entry = FindSym(CurTok.Ident);
        return Entry != 0 && (Entry->Flags & SC_TYPEDEF);
    }
    default:
        return 0;
    }
...
*/
{
    ...
    */
    ...
    case TOK_REGISTER:
    case TOK_EXTERN:
        /* C99's support of declaring after block start */
        DeclareLocals();
        StmtFlags = SF_NONE;
        break;
